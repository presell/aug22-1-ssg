...
export type AlternateMapMarkersvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function AlternateMapMarkersvgIcon(
  props: AlternateMapMarkersvgIconProps
) {
...
export default AlternateMapMarkersvgIcon;
/* prettier-ignore-end */
