...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: z3Dxne9D1hbpjG/css
...
function PlasmicNavLogoOnly__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.column__rdMzN)} />

        <div className={classNames(projectcss.all, sty.column__d6VhI)}>
          <PlasmicLink__
        ...
        <div className={classNames(projectcss.all, sty.column__jHrT3)} />
      </div>
    </div>
